...
# Exportar puerto en Window

En Window no funciona como en Linux y MAC, se debe de correr el siguiente comando para que Kubernete exporte el puerto en Window:

```
kubectl port-forward service/<nombre> 3000:3000
```
